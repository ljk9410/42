...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   print_conversion_diux.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: jung-lee <jung-lee@student.42seoul.kr>     +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/02/23 14:38:27 by jung-lee          #+#    #+#             */
/*   Updated: 2021/03/09 16:06:01 by jung-lee         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char		*make_str(va_list ap)
{
	...
	{
		num_ux = va_arg(ap, unsigned int);
		if (g_opts.type == 'u')
			num_str = ft_itoa_base(num_ux, 10, 'c');
		if (g_opts.type == 'x')
			num_str = ft_itoa_base(num_ux, 16, 'x');
		if (g_opts.type == 'X')
			num_str = ft_itoa_base(num_ux, 16, 'X');
	}
	return (num_str);
...
void		print_conversion_diux(va_list ap)
{
	int				len;
	int				check_p;
	int				check_w;
