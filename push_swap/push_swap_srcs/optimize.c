...
/*   Updated: 2021/07/06 16:20:21 by minhkim          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	return_merge_case(t_oper *op)
{
	...
	if (ft_strcmp(temp->operation, "rra")
		...
		return (1);
	else if (ft_strcmp(temp->operation, "sa")
		&& ft_strcmp(temp->next->operation, "sb"))
		return (2);
	else if (ft_strcmp(temp->operation, "sb")
...
int	return_delete_case(t_oper *op)
{
	...
	if (ft_strcmp(temp->operation, "pa")
		...
		return (1);
	else if (ft_strcmp(temp->operation, "pb")
